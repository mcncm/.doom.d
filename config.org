...
(defun org-babel-execute:cavy (body params)
  ...
  (let* ((cmd "cavy /dev/stdin -o /dev/stdout --target latex"))
...
(map! :after cavy-mode
      ...
      (:prefix ("p" . "phase")
       :desc "parse"
       "a" (lambda () (interactive) (setq cavy-phase "parse"))
       :desc "lower to MIR"
       "m" (lambda () (interactive) (setq cavy-phase "typecheck"))
       :desc "lower and optimize"
       "o" (lambda () (interactive) (setq cavy-phase "optimize"))
