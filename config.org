...
* Introduction
I’ve been migrating from Spacemacs to Doom Emacs, which has made it easier than ever to write a maintainable, human-readable config document. This represents my “first best effort” at translating my previous config.
** Conventions
...
(setq +doom-dashboard-banner-dir "~/.doom.d/banner"
      my/banner-template-file "imperial_encyclopedia.svg"
