...
(setq +doom-dashboard-banner-dir "~/.doom.d/banner"
      ...
      my/banner-template-file (seq-random-elt
                               (directory-files
...
#+begin_src emacs-lisp
(defun my/rustic-cargo-watch ()
  "Run 'cargo check' for the current project."
  (interactive)
  (rustic-run-cargo-command "cargo watch"))
#+end_src
...
(setq cavy-binary "~/proj/cavy/cavy-rs/target/debug/cavy")
...
;;     (cavy-compile-program cavy-preview-buffer body)))
...
(map! :after cavy-mode
      ...
      "q" (lambda () (interactive) (setq cavy-compile-target 'qasm))
      :desc "Set LaTeX compile target"
      "l" (lambda () (interactive) (setq cavy-compile-target 'latex)))
#+end_src
** Company
